...
<div id="wrapper">
	...
	<section id="content">
			...
			<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>Explore all of our services!</h3>
								</div>
							</div>
						</div>		
        <!-- Service Blcoks -->
        <div class="row service-v1 margin-bottom-40">
            <div class="col-md-6 md-margin-bottom-40">
               <img class="img-responsive" src="img/slides/3.jpg" alt="">   
                <h2><a href="seafreight.php">Sea Freight</a></h2>
                       
            </div>
            <div class="col-md-6">
                <img class="img-responsive" src="img/slides/1.jpg" alt="">            
                <h2><a href="airfreight.php">Air Freight</a></h2>
            </div>
        ...
        <div class="row service-v1 margin-bottom-40">
            <div class="col-md-6 md-margin-bottom-40">
               <img class="img-responsive" src="img/Combinepic.jpeg" alt="">   
                <h2><a href="combined.php">Combined Sea Air</a></h2>
                       
            </div>
            <div class="col-md-6">
                <img class="img-responsive" src="img/consol.jpg" alt="">            
                <h2><a href="consolidation.php">Consolidation</a></h2>
            </div>
        ...
        <div class="row service-v1 margin-bottom-40">
            <div class="col-md-6 md-margin-bottom-40">
               <img class="img-responsive" src="img/custom.jpg" alt="">   
                <h2><a href="customclearance.php">Customs Clearance</a></h2>
                       
            </div>
            <div class="col-md-6">
                <img class="img-responsive" src="img/ware.jpg" alt="">            
                <h2><a href="warehousing.php">Warehousing</a></h2>
            </div>
        ...
        <div class="row service-v1 margin-bottom-40">
            <div class="col-md-6 md-margin-bottom-40">
               <img class="img-responsive" src="img/slides/2.jpg" alt="">   
                <h2><a href="roadfreight.php">Road Freight</a></h2>
                       
            </div>
            <div class="col-md-6">
                <img class="img-responsive" src="img/distribution.jpg" alt="">            
                <h2><a href="distribution.php">Distribution</a></h2>
            </div>
        ...
        <div class="row service-v1 margin-bottom-40">
            <div class="col-md-6 md-margin-bottom-40">
               <img class="img-responsive" src="img/goh.jpg" alt="">   
                <h2><a href="goh.php">Garments on Hanger(GOH)</a></h2>
                       
            </div>
            <div class="col-md-6">
                <img class="img-responsive" src="img/aircraft.jpg" alt="">            
                <h2><a href="acs.php">Aircraft Charter Services</a></h2>
            </div>
