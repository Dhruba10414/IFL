...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Aircraft Charter Service</h2>
			</div>
		</div>
	</div>
	</section>
	<section id="content">
        ...
        <div class="row service-v1 margin-bottom-40">
            ...
            <div>
            	<p><strong>
            		Whether its urgent or oversized cargo which requires a special air freighter, IFL Aircraft Charter team is dedicated to provide your aircraft charter needs. For each charter, the IFL Aircraft Charter team works closely with you on every detail of your flight. IFL can arrange for all landing rights, ground handling and cargo loading. IFL can provide pallet buildup/breakdown services.<br><br>

					IFL will even assign a load master to each charter to ensure maximum use of the available space on the aircraft.<br><br>
            		</strong>
            	</p>
            </div>
