...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Air Freight</h2>
			</div>
		</div>
	</div>
	</section>
	<section id="content">
        ...
        <div class="row service-v1 margin-bottom-40">
            ...
            <div>
            	<p><strong>
            		Imperial Freight Ltd. has worked closely with all the major airlines for many years. During this time we have built strong relationships with key airline staff and have developed excellent buying power ability. Encompassed with our on-going support, we pass this benefit on to our clients.<br><br>

					Through our global alliances, we can arrange for your shipments to be collected and forwarded Airport-to-Airport or Door-to-Airport or Door-to-Door. We also offer cross-trade services between countries on the same basis.<br><br>

					In addition, we specialize in the shipment and handling of hazardous and dangerous cargo, having the necessary qualifications and licenses to transport these safely.<br><br>
            		</strong>
            	</p>
            </div>
        ...
        <div>
        	<p>
        		<strong>Our Air Freight Forwarding Services Include:</strong>
        	</p>
        	<br>
        	<ul>
				<li>Door to door delivery to most world-wide locations</li><br>
				
				<li>Qualified personnel for handling dangerous goods</li><br>
				
				<li>Option of carriers based on your cargo needs</li><br>
				
				<li>Project work & flight chartering</li><br>
