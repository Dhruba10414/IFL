...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Consolidation</h2>
			</div>
		</div>
	</div>
	</section>
	<section id="content">
        ...
        <div>
        	<p>
        		<strong>Cargo Consolidation Services Include:</strong>
        	</p>
        	<br>
        	<ul>
				<li>Transportation of cargo to the stuffing point</li><br>
				
				<li>Stuffing of cargo in container</li><br>
				
				<li>Custom process of shipping documents</li><br>
				
				<li>Use of Premium Air/Shipping Lines</li><br>
