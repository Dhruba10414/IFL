...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Distribution</h2>
			</div>
		</div>
	</div>
	</section>
	<section id="content">
        ...
        <div class="row service-v1 margin-bottom-40">
            <div class="col-md-6 md-margin-bottom-40">
               <img class="img-responsive" src="img/distribution.jpg" alt="">   
                       
            </div>
            <div>
            	<p><strong>
            		The challenges in the warehouse and distribution environment are manifold: Streamlining processes, tracking inventory, optimizing shipping and receiving, quickly addressing to changing customer, supplier, regulatory and compliance requirements.<br><br>

            	    The overall goal is to reduce cost to make operations as efficient and profitable as possible. Efficient and flexible warehousing and distribution solutions are becoming more and more important to cut logistics costs, adapt your supply chain infrastructure to rapid changes in the marketplace, and develop new opportunities.<br><br>

					Imperial Freight Logistics offers warehousing facilities and management in strategic locations and provide you cost-efficient distribution solutions.<br><br>
            		</strong>
            	</p>
            </div>
        ...
        <div>
        	<p>
        		<strong>Distribution Services Include:</strong>
        	</p>
        	<br>
        	<ul>
				<li>Bar Code Scanning</li><br>
				
				<li>Contract Warehousing</li><br>
				
				<li>Custom Packaging</li><br>
				
				<li>Innovative Pricing</li><br>

				<li>Inventory Management</li><br>

				<li>Logistics</li><br>

				<li>Refrigerated Services</li><br>

				<li>Shipment Tracking</li><br>

				<li>Tailored Distribution Programs</li><br>
