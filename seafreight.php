...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Sea Freight</h2>
			</div>
		</div>
	</div>
	</section>
	<section id="content">
        ...
        <div class="row service-v1 margin-bottom-40">
            ...
            <div>
            	<p><strong>
            		With a complete range of Sea Freight Services, we leverage volumes smartly to deliver competitive sea transportation in every major trade lane between USA, European & Scandinavian Countries, Canada, Far East Countries and others.<br><br>
            	    Through our network of experienced professionals, strong world shipping connections and extreme flexibility, we are able to specifically respond to whatever your shipping needs may be.<br> <br>
            	    Our representatives stay close to your shipment from pick-up to delivery, keeping you closely informed of its progress.<br><br>
            	    We provide advice, technical assistance and supervision in order to guarantee safe delivery of the cargo at the entire satisfaction of our clients.<br><br>
        ...
        <div>
        	<p>
        		<strong>Our Sea Freight Forwarding Services Include:</strong>
        	</p>
        	<br>
        	<ul>
				<li>P.O Management & Buyers Consolidation</li><br>
				
				<li>Full Container Load (FCL)</li><br>
				
				<li>Less than Container Load (LCL)</li><br>
				
				<li>Over sized & Project Cargo</li><br>

				<li>Dangerous Goods Handling</li><br>

				<li>Door-to-Door Import and Export Worldwide</li><br>

				<li>Warehousing & Distribution</li><br>

				<li>Customs Brokerage</li><br>

				<li>Inter modal & Multi modal Transport</li><br>
