...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Combined Sea Air</h2>
			</div>
		</div>
	</div>
	</section>
	<section id="content">
        ...
        <div class="row service-v1 margin-bottom-40">
            ...
            <div>
            	<p><strong>
            		Imperial Freight Ltd. is well prepared to meet all your needs by introducing different modes of transportation to save cost while meeting your requirements. As such, we have successfully integrated superior air and ocean capabilities with innovative systems to help you accomplish best results, within time given with flexibility. Sea/Air/Air-Sea is well accepted by many of our customers and is proven effective.<br><br>
