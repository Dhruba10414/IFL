...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">GARMENTS ON HANGER (GOH)</h2>
			</div>
		</div>
	</div>
	</section>
	<section id="content">
        ...
        <div class="row service-v1 margin-bottom-40">
            <div class="col-md-6 md-margin-bottom-40">
               <img class="img-responsive" src="img/goh.jpg" alt="">   
                       
            </div>
            <div>
            	<p><strong>
            		Imperial Freight Ltd. is specialized in GOH with over 10 years experience. Our dedicated specialists pick, pack, sort and hang garments with extreme care to ensure maximum protection and at the same time to eliminate refurbishing at destination, we strictly adhere to quality control procedures. <br><br>

            		We are expert in providing and / or handling tailor-made equipment to suit the need of shipment assigned. Aside of maximizing space utilization, much attention is paid to ensure the garment in good genuine shapes during and after shipping by air or sea.<br><br>
            		</strong>
            	</p>
            </div>
        ...
        <div>
        	<p>
        		<strong>GARMENTS ON HANGER (GOH) Services Include:</strong>
        	</p>
        	<br>
        	<ul>
				<li>Tailor-made equipment</li><br>
				
				<li>Maximum utilization of space</li><br>
				
				<li>Selection of hangers PERSONALIZED</li><br>
				
				<li>Garments to be sorted by color, size and style as per instruction of consignee</li><br>

				<li>Garments inspected before and during loading</li><br>

				<li>Photos taken before, during and after garment on hanger. Photos will be sent by e-mail to consignee immediately</li><br>

				<li>Full laundry insurance is provided for protection</li><br>

				<li>Guaranteed to meet your specifications</li><br>
